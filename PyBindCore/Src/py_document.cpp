...
void init_document(py::module_& m)
{
    py::class_<PyFacade::DocumentFacade, std::shared_ptr<PyFacade::DocumentFacade>>(m, "Document")
        ...
        .def_static("open", &PyFacade::DocumentFacade::open, py::arg("path"),
            "Open a document from file (not implemented yet)")
        ...
        .def("query_box", &PyFacade::DocumentFacade::queryBox,
            py::arg("box"), py::arg("contained_only") = false)
